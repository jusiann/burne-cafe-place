  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled
          ? 'bg-white/90 backdrop-blur-xl shadow-[0_2px_20px_-5px_rgba(0,0,0,0.1)] border-b border-[#E8E0D5]/50'
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => (
              ...
              >
                {item.name}
                {isActiveRoute(item.href) && (
                  <span className="absolute bottom-0 left-2 right-2 h-0.5 bg-[#C46A2B] rounded-full" />
                )}
              </Link>
            ))}
