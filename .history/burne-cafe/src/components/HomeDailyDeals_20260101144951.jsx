...
function HomeDailyDeals() {
    ...
    const copyCouponCode = (code) => {
        console.log('Kopyalanan kupon:', code);
        
        // Modern clipboard API (HTTPS/localhost gerektirir)
                                                ...
                                                <div className="flex flex-row gap-2 w-full md:w-auto md:flex-shrink-0 md:mr-3">
                                                    ...
                                                    >
                                                        ...
                                                        {copiedCode === coupon.code && (
                                                            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-white text-[#C46A2B] text-[10px] px-1.5 py-0.5 rounded shadow-md whitespace-nowrap z-50 animate-pulse">
                                                                ✓ Kopyalandı
                                                            </span>
                                                        )}
                                                    </button>
