                                                ...
                                                <div className="flex flex-row gap-2 w-full md:w-auto md:flex-shrink-0 md:mr-3">
                                                    ...
                                                    >
                                                        ...
                                                        {copiedCode === coupon.code && (
                                                            <span className="absolute -top-9 left-1/2 -translate-x-1/2 bg-white text-[#C46A2B] text-sm font-semibold px-3 py-1.5 rounded-lg shadow-xl whitespace-nowrap z-10 animate-bounce">
                                                                ✓ Kopyalandı!
                                                            </span>
                                                        )}
                                                    </button>
