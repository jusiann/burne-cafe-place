                                            ...
                                            <div className="flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-0">
                                                ...
                                                <div className="flex flex-row gap-2 w-full md:w-auto md:flex-shrink-0 md:mr-3">
                                                    <button
                                                        ...
                                                        className="flex-1 md:flex-initial bg-white/20 backdrop-blur-sm px-3 py-2 rounded-lg border border-white/30 hover:bg-white/30 transition-all duration-300 cursor-pointer"
                                                    >
