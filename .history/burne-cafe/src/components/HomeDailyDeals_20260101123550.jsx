    ...
    return (
        <section className="py-20 bg-gradient-to-br from-[#2B1E17] via-[#3D2B20] to-[#2B1E17] relative overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 p-5 md:p-7 bg-gradient-to-r from-[#C46A2B] to-[#A85A24] rounded-2xl max-w-4xl mx-auto relative overflow-hidden">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-0">
                                                ...
                                                <div className="hidden md:block h-16 w-px bg-gradient-to-b from-white/20 via-white/40 to-white/20 mx-6" />
