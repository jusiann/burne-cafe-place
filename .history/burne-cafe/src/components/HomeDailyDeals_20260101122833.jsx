                                            ...
                                            <div className="flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-4">
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto md:flex-shrink-0">
                                                    <button
                                                        ...
                                                        className="relative bg-white/20 backdrop-blur-sm px-3 py-2 rounded-lg border border-white/30 hover:bg-white/30 transition-all duration-300 cursor-pointer"
                                                    >
                                                    ...
                                                    <Link
                                                        to="/menu"
                                                        className="inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-white text-[#C46A2B] text-sm font-semibold rounded-lg hover:bg-white/90 hover:shadow-lg transition-all duration-300 whitespace-nowrap"
                                                    >
                                                        Sipariş Ver
