...
function DealCard({ product }) {
    ...
    return (
        ...
        >
            {/* IMAGE */}
            <div className="flex-shrink-0 w-24 h-24 bg-gradient-to-br from-[#5D4037] to-[#3E2723] rounded-xl flex items-center justify-center">
                <div className="w-14 h-14 rounded-full border-3 border-[#8D6E63] bg-gradient-to-br from-[#5D4037] to-[#4E342E] flex items-center justify-center">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#4E342E] to-[#3E2723] border border-[#6D4C41]" />
                </div>
            </div>
