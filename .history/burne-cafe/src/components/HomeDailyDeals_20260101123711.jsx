                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-0">
                                                {/* Sol: Icon + Yazılar */}
                                                <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0 md:pr-4">
                                                ...
                                                <div className="hidden md:block h-12 w-px bg-gradient-to-b from-white/20 via-white/40 to-white/20 mx-4" />
