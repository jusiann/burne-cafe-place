...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-18">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-2 px-4 py-2 text-[#2B1E17]/70 hover:text-[#C46A2B] hover:bg-[#C46A2B]/5 rounded-lg transition-all duration-300"
            aria-label="Arama"
          >
      ...
      <div
        className={cn(
          "absolute top-0 left-0 right-0 bg-white shadow-xl transition-all duration-300 ease-out overflow-hidden",
          isSearchOpen ? "h-18 opacity-100" : "h-0 opacity-0 pointer-events-none"
        )}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center gap-4">
          <Search className="w-6 h-6 text-[#C46A2B]" />
          <form onSubmit={handleSearchSubmit} className="flex-1">
            <input
              ...
              placeholder="Ürün, kategori veya yemek ara..."
              className="w-full px-4 py-2 text-[#2B1E17] placeholder:text-[#2B1E17]/40 bg-transparent border-none outline-none focus:ring-0"
            />
          </form>
          <button
            onClick={handleSearchClose}
            className="p-2 text-[#2B1E17]/70 hover:text-[#C46A2B] hover:bg-[#C46A2B]/5 rounded-lg transition-all duration-300"
