                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {order.status === 'preparing' && (
                                                <button
                                                    ...
                                                    className="px-4 py-2.5 bg-white border-2 border-[#3D2817] text-[#3D2817] font-semibold rounded-lg hover:bg-[#F5F1EB] hover:shadow-lg transition-all flex items-center gap-2"
                                                >
