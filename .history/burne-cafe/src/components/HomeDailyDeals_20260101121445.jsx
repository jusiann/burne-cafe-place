...
const couponDetails = {
    'ILK15': {
        ...
        description: '%15 İndirim',
        conditions: 'İlk siparişinizde geçerlidir.'
    },
    'IKILIM20': {
        title: 'Caffee Date',
        description: 'Americano & Latte %20 indirim',
        conditions: 'Americano ve Latte bir arada alındığında geçerli.'
    },
    'MIEL10': {
        title: 'Miêl',
        description: 'Miel İçin Ekstra Ürünlerde %10',
        conditions: 'Miel kahve için ekstra ürünlerde geçerli.'
    }
};
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 p-4 md:p-6 bg-gradient-to-r from-[#C46A2B] to-[#A85A24] rounded-2xl max-w-4xl mx-auto relative overflow-hidden">
                    <div className="flex items-center justify-between gap-6">
                                            ...
                                            <div className="flex flex-col md:flex-row items-center md:items-start gap-3">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="text-left">
                                                        <p className="text-white/80 text-xs">{details?.title}</p>
                                                        <p className="text-white font-bold text-lg">{details?.description}</p>
                                                        <p className="text-white/70 text-xs mt-0.5 line-clamp-1">{details?.conditions}</p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="hidden md:flex flex-col items-center gap-3 h-full py-2">
                            {coupons.map((_, index) => (
                                <button
                                    key={index}
                                    ...
                                    className={`
                                        ...
                                        duration-500
                                        cursor-pointer
                                        ${index === activeCouponIndex ? 'h-12' : 'h-6'}
                                    `}
                                >
                                    <span
                                        className={`
