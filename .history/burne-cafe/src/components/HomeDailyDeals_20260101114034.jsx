                                        ...
                                        <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="text-left">
                                                    <p className="text-white/80 text-sm">{coupon.title}</p>
                                                    <p className="text-white font-bold text-xl">{coupon.description}</p>
                                                    <p className="text-white/70 text-xs mt-1">{coupon.conditions}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4 flex flex-col sm:flex-row items-center gap-3">
                                            <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/30">
                                                <p className="text-white/90 text-sm">
                                                    Kupon kodu: <span className="font-bold text-lg">{coupon.code}</span>
                                                </p>
                                            </div>
                                            <Link
                                                to="/menu"
                                                className="inline-flex items-center gap-2 px-6 py-2.5 bg-white text-[#C46A2B] font-medium rounded-xl hover:bg-white/90 hover:shadow-2xl transition-all duration-300"
                                            >
                                                Sipariş Ver
