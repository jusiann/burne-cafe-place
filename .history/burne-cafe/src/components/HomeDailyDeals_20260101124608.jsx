                ...
                <div className="mt-12 p-4 bg-gradient-to-r from-[#C46A2B] to-[#A85A24] rounded-2xl max-w-4xl mx-auto relative overflow-hidden">
                    <div className="flex items-center justify-between gap-3 md:gap-4">
                        ...
                        <div className="flex-1 min-w-0 relative">
                            {/* COPIED NOTIFICATION - Dışarıda, tüm kuponlar için ortak */}
                            {copiedCode && (
                                <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white text-[#C46A2B] text-[10px] px-1.5 py-0.5 rounded shadow-md whitespace-nowrap z-50 animate-pulse">
                                    ✓ Kopyalandı
                                </div>
                            )}
                                                ...
                                                <div className="flex flex-row gap-2 w-full md:w-auto md:flex-shrink-0 md:mr-3">
                                                    ...
                                                    >
                                                        ...
                                                        {copiedCode === coupon.code && (
                                                            <span className="absolute -top-6 left-1/2 -translate-x-1/2 bg-white text-[#C46A2B] text-[10px] px-1.5 py-0.5 rounded shadow-md whitespace-nowrap z-10 animate-pulse">
                                                                Kopyalandı!
                                                            </span>
                                                        )}
                                                    </button>
