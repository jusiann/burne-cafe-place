    ...
    return (
        <section className="py-20 bg-gradient-to-br from-[#2B1E17] via-[#3D2B20] to-[#2B1E17] relative overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 p-5 md:p-6 bg-gradient-to-r from-[#C46A2B] to-[#A85A24] rounded-2xl max-w-4xl mx-auto relative overflow-hidden">
                                        ...
                                        >
                                            <div className="flex items-start gap-2 md:gap-3 mb-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-white font-bold text-base md:text-lg mb-1 leading-tight">{details?.description}</p>
                                                    <p className="text-white/80 text-xs leading-snug line-clamp-2">{details?.conditions}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                                                <button
                                                    ...
                                                    className="relative w-full sm:w-auto bg-white/20 backdrop-blur-sm px-3 py-2 rounded-lg border border-white/30 hover:bg-white/30 transition-all duration-300 cursor-pointer"
                                                >
                                                ...
                                                <Link
                                                    to="/menu"
                                                    className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-white text-[#C46A2B] text-sm font-semibold rounded-lg hover:bg-white/90 hover:shadow-lg transition-all duration-300 whitespace-nowrap"
                                                >
                                                    Sipariş Ver
