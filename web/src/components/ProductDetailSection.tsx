...
import type { Product, Extra, ProductSize, MilkOption } from '../types/product';
...
function ProductDetailSection({ product }: ProductDetailSectionProps) {
    ...
    const [selectedMilk, setSelectedMilk] = useState<MilkOption | null>(product.milkOptions?.[0] ?? null);
