            ...
            <div className="group h-full flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="flex-1 flex flex-col p-4">
                    <div className="flex-1">
                        <div className="text-xs text-[#C46A2B] font-medium mb-1">{product.category}</div>
                    ...
                    <div className="relative mt-3 pt-3">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-baseline gap-2">
                                ...
                                {hasDiscount && <span className="text-sm text-[#8B7E75] line-through">₺{product.price}</span>}
                            </div>
                            <button onClick={handleAddToCart} className={`p-2 rounded-lg transition-all duration-300 ${isAdded ? 'bg-green-500 text-white' : 'bg-[#C46A2B]/10 hover:bg-[#C46A2B] text-[#C46A2B] hover:text-white'}`} aria-label="Sepete Ekle">
        ...
        <>
            ...
            <section className="py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="text-sm text-[#8B7E75]">{filteredProducts.length} ürün bulundu</div>
